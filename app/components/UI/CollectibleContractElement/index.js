...
function CollectibleContractElement({
	...
	// zyl NFT
	if (chainId = 366) {
		asset.logo = "https://hld-chain.oss-cn-beijing.aliyuncs.com/tokens/" + asset.address + ".png";
	} else {
		asset.logo = "https://hld-chain.oss-cn-beijing.aliyuncs.com/tokens/" + chainId + "/" + asset.address + ".png";
	}
