...
const styles = StyleSheet.create({
	...
	happywalletNameTransparentWrapper: {
		alignItems: 'center',
		justifyContent: 'center',
		flex: 1,
	},
	happywalletNameWrapper: {
 ...
 * which contains accounts icon, Title or happywallet Logo and current network, and settings icon
 *
 ...
 * which is just the happywallet log and the Back button
 *
...
export function getOnboardingNavbarOptions(navigation, route, { headerLeft } = {}) {
	...
	return {
		...
		headerTitle: () => (
			<View style={styles.happywalletNameTransparentWrapper}>
	...
	return {
		...
		headerLeft: () => (
			<View style={styles.optinHeaderLeft}>
				<View style={styles.happywalletNameWrapper}>
