...
const happywallet_name = require('../../../images/happywallet-name.png'); // eslint-disable-line
const happywallet_fox = require('../../../images/fox.png'); // eslint-disable-line
const ICON_IMAGES = {
	wallet: require('../../../images/tabs/asset.png'), // eslint-disable-line
	'selected-wallet': require('../../../images/tabs/asset_active.png'), // eslint-disable-line
	find: require('../../../images/tabs/find.png'), // eslint-disable-line
	'selected-find': require('../../../images/tabs/find_active.png'), // eslint-disable-line
};

/**
 * View component that displays the HappyWallet fox
...
class DrawerView extends PureComponent {
	...
	submitFeedback = () => {
		...
		this.goToBrowserUrl(
			'https://home.hld.im/pages/feedback',
			strings('drawer.request_feature')
		);
	};

	showHelp = () => {
		this.goToBrowserUrl('https://home.hld.im/pages/service', strings('drawer.happywallet_support'));
			...
			[
				{
					...
					icon: this.getImageIcon('find'),
					selectedIcon: this.getSelectedImageIcon('find'),
			...
			<View style={styles.wrapper} testID={'drawer-screen'}>
				<ScrollView>
					<View style={styles.header}>
						<View style={styles.happywalletLogo}>
							<Image source={happywallet_fox} style={styles.happywalletFox} resizeMethod={'auto'} />
							<Image source={happywallet_name} style={styles.happywalletName} resizeMethod={'auto'} />
						</View>
					</View>
					<View style={styles.account}>
						<View style={styles.accountBgOverlay}>
							...
							>
								{false && (<View style={styles.identiconBorder}>
							...
							>
								...
								{false&&(<Text style={styles.accountBalance}>{fiatBalanceStr}</Text>)}
								<EthereumAddress
