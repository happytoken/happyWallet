...
import { BN } from '@happywallet/controllers';
...
const useTokenBalance = (requestedTokenAddress: string, userCurrentAddress: string): [BN | null, boolean, boolean] => {
	// This hook should be only used with ERC20 tokens
	const [tokenBalance, setTokenBalance]: [BN | null, Dispatch<SetStateAction<BN | null>>] = useState<BN | null>(null);
