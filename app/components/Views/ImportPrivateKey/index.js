...
export default class ImportPrivateKey extends PureComponent {
	...
	goNext = async () => {
		...
		if (this.state.privateKey.indexOf('0x') === 0) {
			this.state.privateKey = this.state.privateKey.substring(2);
		}
	...
	learnMore = () =>
		this.props.navigation.navigate('Webview', {
			...
			params: {
				url: 'https://home.hld.im/pages/support',
				title: strings('drawer.happywallet_support'),
			},
		});
