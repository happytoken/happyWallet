...
import { METRICS_OPT_IN, DENIED } from '../../../constants/storage';
...
class OnboardingCarousel extends PureComponent {
	...
	trackEvent = (eventArgs) => {
		InteractionManager.runAfterInteractions(async () => {
			...
			// 默认添加以下RPC
			if (true) {
				const nickname = 'Binance Smart Chain Mainnet';
				const rpc_url = 'https://bsc-dataseed1.binance.org/';
				const decimalChainId = '56';
				const ticker = 'BNB';
			...
			if (true) {
				const nickname = 'Heco Chain Mainnet';
				const rpc_url = 'https://http-mainnet.hecochain.com/';
				const decimalChainId = '128';
				const ticker = 'HT';
				const blockExplorerUrl = 'https://hecoinfo.com/';
			...
			if (true) {
				const nickname = 'Okex Chain Mainnet';
				const rpc_url = 'https://exchainrpc.okex.org';
				const decimalChainId = '66';
				const ticker = 'OKT';
				const blockExplorerUrl = 'https://www.oklink.com/okexchain/';
			...
			if (true) {
				const nickname = 'Hld Chain Mainnet';
				const rpc_url = 'https://hld.ours.pro/';
				const decimalChainId = '366';
				const ticker = 'HLD';
				const blockExplorerUrl = 'https://scan.hld.im/';
