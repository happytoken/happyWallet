...
const happywalletErrorImage = require('../../../images/happywallet-error.png');
	...
	<SafeAreaView style={styles.container}>
		<ScrollView style={styles.content}>
			<View style={styles.header}>
				<Image source={happywalletErrorImage} style={styles.errorImage} />
...
class ErrorBoundary extends Component {
	...
	openTicket = () => {
		const url = 'https://home.hld.im/pages/ticket';
		Linking.openURL(url);
	};
