...
import { NetworksChainId } from '@happywallet/controllers';
...
export class BackgroundBridge extends EventEmitter {
	constructor({ webview, url, getRpcMethodMiddleware, isMainFrame }) {
		...
		// connect features
		this.setupProviderConnection(mux.createStream('happywallet-provider'));
	...
	setupProviderEngine() {
		...
		// forward to happywallet primary provider
	...
	/**
	 * The happywallet-state of the various controllers, made available to the UI
	 *
