...
const defaultOptions = {
	service: 'com.happywallet',
	authenticationPromptTitle: strings('authentication.auth_prompt_title'),
	authenticationPrompt: { title: strings('authentication.auth_prompt_desc'), rcancel: strings('authentication.fingerprint_prompt_cancel') },
 ...
 * abstracting happywallet specific functionality and settings
...
export default {
	...
	async setGenericPassword(password, type) {
		...
		await Keychain.setGenericPassword('happywallet-user', encryptedPassword, { ...defaultOptions, ...authOptions });
