...
import im.hld.nativeModules.RCTAnalyticsPackage;
...
import im.hld.nativeModules.PreventScreenshotPackage;
    ...
    private static void initializeFlipper(
    	...
    	if (BuildConfig.DEBUG) {
    		try {
    		  ...
    		  */
    		  Class<?> aClass = Class.forName("im.hld.ReactNativeFlipper");
    		  aClass
